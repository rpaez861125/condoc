        ...
        <div class="row sameheight-container">
            <div class="col-md-8 align-content-center">
                <div class="card card-block sameheight-item"> 
                    {!! Form::open(['route' => 'groups.store', 'role' => 'form', 'method' => 'POST']) !!}                                   
                        {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            {!! Form::label('grade_id', 'Grados', ['class' => 'control-label']) !!}
                            {!! Form::select('grade_id', $grades, null, ['class' => 'form-control underlined']) !!}
                        </div> 
